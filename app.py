...
if selected_rows is not None and len(selected_rows) > 0:
    ...
    if sym:
        ...
        with ws_tabs[0]:
            ...
            st.info("🔒 NSE blocks external embedding. Please click 'Open in Browser' above to view the chart.")
            # iframe removed here to prevent the red error box
        ...
        with ws_tabs[3]:
            ...
            st.info("🔒 Screener blocks external embedding. Please click 'Open in Browser' above to view filings.")
            # iframe removed here to prevent the red error box
        ...
        with ws_tabs[4]:
            ...
            st.info("🔒 Zerodha blocks external embedding. Please click 'Open in Browser' above to view metrics.")
            # iframe removed here to prevent the red error box
        ...
        with ws_tabs[6]:
            ...
            st.caption("📱 Interactive Chart Widget:")
            
            # Replaced broken iframe with Official TradingView Widget
            tv_widget = f"""
            ...
            """
            components.html(tv_widget, height=box_height)
