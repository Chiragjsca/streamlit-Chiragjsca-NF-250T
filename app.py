...
"""
        ...
        with ws_tabs[3]:
            ...
            if not ai_enabled:
                ...
                st.write("Generate a custom TradingView Pine Script v5 strategy.")
...
Here is the live fundamental and technical data for {sym}:
{clean_row_context}

Formatting Requirements:
1. Start with `//@version=5` and `strategy("{sym} Custom Script", overlay=true)`
2. Include clear comments explaining the logic.
3. Provide ONLY the Pine Script code inside a markdown code block.
"""
            ...
            st.markdown("---")
            st.markdown("**📋 Custom Rules Reference**")
